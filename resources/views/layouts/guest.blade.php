...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'عالم نورا للكنوز') }}</title>
        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center py-12 px-4">
            <div class="mb-8">
                <a href="/" class="flex items-center gap-2.5">
                    <img src="{{ asset('images/nora/logo.jpeg') }}" alt="عالم نورا للكنوز" class="h-10 w-auto object-contain">
                </a>
            </div>
            ...
            <p class="mt-8 text-xs text-stone-400">
                &copy; {{ date('Y') }} عالم نورا للكنوز. All rights reserved.
            </p>
        </div>
    </body>
</html>
